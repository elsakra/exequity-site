...
"services": {
"compensation-benchmarking-program-design.md": {
	id: "compensation-benchmarking-program-design.md";
  slug: "compensation-benchmarking-program-design";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"technical-governance-compliance.md": {
	id: "technical-governance-compliance.md";
  slug: "technical-governance-compliance";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"transactions-and-transitions.md": {
	id: "transactions-and-transitions.md";
  slug: "transactions-and-transitions";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
